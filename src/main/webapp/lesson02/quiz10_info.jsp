...
%>
	<div id="wrap" class="container">
		...
		<nav>
			<ul class="nav">
				<li class="nav-item"><a href="/lesson02/quiz10_list.jsp" class="nav-link text-dark font-weight-bold">멜롱차트</a></li>
				<li class="nav-item"><a href="/lesson02/quiz10_list.jsp" class="nav-link text-dark font-weight-bold">최신음악</a></li>
				<li class="nav-item"><a href="/lesson02/quiz10_list.jsp" class="nav-link text-dark font-weight-bold">장르음악</a></li>
				<li class="nav-item"><a href="/lesson02/quiz10_list.jsp" class="nav-link text-dark font-weight-bold">멜롱DJ</a></li>
				<li class="nav-item"><a href="/lesson02/quiz10_list.jsp" class="nav-link text-dark font-weight-bold">뮤직어워드</a></li>
			</ul>
		</nav>
